<x-app-layout>
    <div class="py-4">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <h1 class="text-3xl mb-4 text-slate-200 font-bold">
                Update Log: <strong class="font-bold text-cyan-400">{{ $post->title }}</strong>
            </h1>
            ...
            <div class="bg-[#162032]/50 border border-[#23304A] overflow-hidden sm:rounded-lg p-8 backdrop-blur-sm">
                ...
                enctype="multipart/form-data" method="post">
                    ...
                    @if ($post->imageUrl())
                        <div class="mb-8 border border-[#23304A] rounded-lg overflow-hidden p-1 bg-[#050912]">
                            <img src="{{ $post->imageUrl() }}" alt="{{ $post->title }}" class="w-full rounded opacity-80 hover:opacity-100 transition-opacity">
                        </div>
                    @endif
